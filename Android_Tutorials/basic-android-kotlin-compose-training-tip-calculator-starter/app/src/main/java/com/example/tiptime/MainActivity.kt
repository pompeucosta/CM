...
fun TipTimeLayout() {
    ...
    Column(
        ...
        RoundTheTipRow(
            roundUp = roundUp,
            onCheckedRoundUpChanged = {roundUp = it},
...
@Composable
fun RoundTheTipRow(roundUp: Boolean,onCheckedRoundUpChanged: (Boolean) -> Unit,modifier: Modifier = Modifier) {
    Row(
        modifier = modifier
            .fillMaxWidth()
            .size(48.dp),
        ...
        Switch(
            ...
            checked = roundUp,
            onCheckedChange = onCheckedRoundUpChanged
        )
    }
}
